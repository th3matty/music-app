...
class LyricsBox extends React.Component {
	...
	render() {
		return (
			<div className=" w-56 max-w-sm shadow-lg bg-colorPallete_LightGreen  overflow-x-hidden">
				...
				<div className="px-6 py-4">
					...
					<h3>Track:</h3>{' '}
					<span className="font-bold text-colorPallete_Blue text-lg">{this.state.trackName}</span>
